...
public class SwingLooch extends JFrame {
	...
	public SwingLooch() {
		...
		// Add scrollbars
		ThreadScrollbar dronesScrollbar = new ThreadScrollbar(droneyThread, 0, new Color((float)0.1, (float)0.7, (float)0.7), new Point(25, 45));
		ThreadScrollbar sequencesScrollbar = new ThreadScrollbar(seqThread, 79, new Color((float)0.2, (float)0.6, (float)0.7), new Point(70, 45));
		ThreadScrollbar warblesScrollbar = new ThreadScrollbar(warbleThread, 86, new Color((float)0.3, (float)0.5, (float)0.7), new Point(115, 45));
		ThreadScrollbar burstsScrollbar = new ThreadScrollbar(burstThread, 88, new Color((float)0.4, (float)0.4, (float)0.7), new Point(160, 45));
		add(dronesScrollbar);
